...
import { kityEventListener } from './event-listener';

export type KityBaseUtils = {
  addEvent: typeof kityEventListener.addEvent;
  trigger: typeof kityEventListener.trigger;
...
const kityBaseUtils: KityBaseUtils = {
  addEvent: kityEventListener.addEvent,
  trigger: kityEventListener.trigger,
  each: utils.each,
  extend: utils.extend,
  clone: utils.clone,
  copy: utils.copy,
