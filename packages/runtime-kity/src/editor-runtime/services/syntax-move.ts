...
const MoveComponent = kity.createClass('MoveComponent', {
  constructor(this: MoveComponentInstance, parentComponent: SyntaxParent, kfEditor: KityRuntimeEditorInstance) {
...
export default MoveComponent as new (parentComponent: SyntaxParent, kfEditor: KityRuntimeEditorInstance) => MoveComponentInstance;
