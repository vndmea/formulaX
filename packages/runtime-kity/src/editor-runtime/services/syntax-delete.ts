...
const DeleteComponent = kity.createClass('DeleteComponent', {
  constructor(this: DeleteComponentInstance, parentComponent: SyntaxParent, kfEditor: KityRuntimeEditorInstance) {
...
export default DeleteComponent as new (parentComponent: SyntaxParent, kfEditor: KityRuntimeEditorInstance) => DeleteComponentInstance;
