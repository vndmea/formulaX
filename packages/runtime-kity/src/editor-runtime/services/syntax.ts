...
const SyntaxComponent = kity.createClass('SyntaxComponenet', {
  constructor(this: SyntaxComponentInstance, kfEditor: KityRuntimeEditorInstance) {
  ...
  isGroupNode(this: SyntaxComponentInstance, groupId: string) {
    ...
    return type === kityGroupType.GROUP || type === kityGroupType.VIRTUAL;
  },

  isVirtualNode(this: SyntaxComponentInstance, groupId: string) {
    return this.objTree!.mapping[groupId].strGroup.attr!['data-type'] === kityGroupType.VIRTUAL;
  },
...
export default SyntaxComponent as new (kfEditor: KityRuntimeEditorInstance) => SyntaxComponentInstance;
