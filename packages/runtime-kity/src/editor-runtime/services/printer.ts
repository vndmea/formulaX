...
const Printer = kity.createClass('Printer', {
  constructor(this: PrinterComponentInstance, kfEditor: KityRuntimeEditorInstance) {
...
export default Printer as new (kfEditor: KityRuntimeEditorInstance) => PrinterComponentInstance;
