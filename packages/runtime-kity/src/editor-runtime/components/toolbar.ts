...
const Toolbar = kity.createClass('Tollbar', {
  constructor(this: ToolbarInstance, uiComponent: ToolbarUiComponent, kfEditor: KityRuntimeEditorInstance, elementList: ToolbarElementDefinition[]) {
...
function createElement(type: unknown, doc: Document, options?: Record<string, unknown>) {
  switch (type) {
    case kityElementType.DRAPDOWN_BOX:
      return createDrapdownBox(doc, options);
    case kityElementType.DELIMITER:
      return createDelimiter(doc);
    case kityElementType.AREA:
